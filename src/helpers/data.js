export const data = ` Déjame comentarte un poco a que me dedico. Soy trader profesional ya
...
tipo de activos.`;
export const fullData = ` Claro esta, que ese esfuerzo no solo vino por
